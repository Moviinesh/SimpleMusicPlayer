...
organized_menu = Menu(menu_bar, tearoff=False)
organized_menu.add_command(label="Select folder with your music", command=load_music)
menu_bar.add_cascade(label="Organise", menu=organized_menu)
